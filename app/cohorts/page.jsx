...
const BookIcon = ({ className = "w-5 h-5 text-[#0b3574] dark:text-[#38bdf8]" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
  </svg>
)

const CogIcon = ({ className = "w-5 h-5 text-[#0b3574] dark:text-[#38bdf8]" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const UsersIcon = ({ className = "w-5 h-5 text-[#0b3574] dark:text-[#38bdf8]" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
  </svg>
)

const HelpIcon = ({ className = "w-4 h-4 text-[#0b3574] dark:text-[#38bdf8]" }) => (
...
const PROGRAMS_DATA = {
  gate2027: [
    ...
    },
    {
      ...
      originalPrice: "₹9,999",
      badge: "Most Popular",
      badgeColor: "bg-[#061d33] dark:bg-[#0b3574]",
      ...
      btnText: "Enroll Now",
      btnStyle: "bg-[#0b3574] text-white hover:bg-[#07214a] shadow-md shadow-[#0b3574]/20",
    ...
    },
    {
      ...
      btnStyle: "border border-[#0b3574] dark:border-[#38bdf8] text-[#0b3574] dark:text-[#38bdf8] hover:bg-[#0b3574]/5",
...
export default function CohortsPage() {
  ...
  const getPersonalizedHero = () => {
    if (quizStep === 3) {
      if (quizYear === "2028") {
        return {
          title: <>Master GATE CS Over <span className="text-[#0b3574] dark:text-[#38bdf8]">24 Months</span></>,
      ...
      if (quizPrep === "beginner") {
        return {
          title: <>Master GATE CS Concepts from <span className="text-[#0b3574] dark:text-[#38bdf8]">First Principles</span></>,
      ...
      return {
        title: <>Decode Examiner Traps & <span className="text-[#0b3574] dark:text-[#38bdf8]">Boost Your Rank</span></>,
    ...
    return {
      title: <>India’s Trusted <span className="text-[#0b3574] dark:text-[#38bdf8]">GATE CS</span> Preparation Platform</>,
  ...
  return (
    <div className="cohorts-page min-h-screen bg-[#fafbfc] dark:bg-[#070b15] text-slate-900 dark:text-gray-100  transition-colors duration-300">
      ...
      <div className="bg-[#0b3574] text-white text-center py-2.5 px-4 text-xs font-semibold flex items-center justify-center gap-2 border-b border-[#051836] z-50 relative">
      ...
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-[#070b15]/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-6 lg:px-[8%] py-4 flex items-center justify-between transition-all duration-300">
        ...
        <div className="flex items-center gap-6 lg:gap-8">
          <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-sm font-semibold text-slate-700 dark:text-gray-200">
            <a href="https://cohorts.nileshnama.com/new-courses?examId=6" target="_blank" rel="noopener noreferrer" className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition">Tracks</a>
            <a href="https://cohorts.nileshnama.com/new-courses?examId=1" target="_blank" rel="noopener noreferrer" className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition">Programs</a>
            <a href="https://cohorts.nileshnama.com/new-courses?examId=2" target="_blank" rel="noopener noreferrer" className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition">Interviews</a>
            <a href="https://cohorts.nileshnama.com/new-courses?examId=3" target="_blank" rel="noopener noreferrer" className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition">Mentorship</a>
            <a href="https://cohorts.nileshnama.com/test-series" target="_blank" rel="noopener noreferrer" className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition">Test Series</a>
            <a href="https://nquestions.in" target="_blank" rel="noopener noreferrer" className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition">NQuestions</a>
            
            {/* Custom Dropdown */}
            <div className="relative">
              <button
                onClick={() => setMoreOpen(!moreOpen)}
                className="hover:text-[#0b3574] dark:hover:text-[#38bdf8] transition flex items-center gap-1.5 font-semibold"
              >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#061d33] hover:bg-black text-white dark:bg-[#0b3574] dark:hover:bg-[#38bdf8] font-semibold px-6 py-2 rounded-full text-sm transition-all duration-300 shadow-sm shrink-0"
          >
            Explore Programs
          </a>
        </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#f8fafc] via-[#f1f7fc] to-[#e2edf8] text-[#061d33] dark:from-[#070b15] dark:via-[#0d1527] dark:to-[#0f172a] dark:text-white pt-20 pb-24 text-center px-4 sm:px-6">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] rounded-full bg-[#0b3574]/5 blur-3xl -z-10" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#0b3574] hover:bg-[#07214a] text-white font-bold px-7 py-3 rounded-xl text-xs sm:text-sm tracking-wide transition-all duration-300 shadow-lg shadow-[#0b3574]/20 w-full sm:w-auto text-center"
            >
            ...
            >
              ...
              <PlayIcon className="w-4 h-4 text-[#0b3574]" />
            </button>
          </div>
          ...
          <div className="mt-12 max-w-2xl mx-auto rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-[#0d1527]/70 backdrop-blur p-6 sm:p-8 shadow-lg text-center">
            <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#0b3574] dark:text-[#38bdf8]">Prep Matcher</span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center gap-3 pt-2">
                    ...
                    <a
                      ...
                      className="px-6 py-2 rounded-xl bg-[#0b3574] hover:bg-[#07214a] text-white text-xs font-bold transition shadow shadow-[#0b3574]/20"
                    >
                      View Package
                    </a>
                  </div>
      ...
      <section className="py-20 px-4 sm:px-6 bg-slate-50/50 dark:bg-slate-900/10 border-t border-b border-slate-100 dark:border-slate-800">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/3 text-center md:text-left relative flex flex-col items-center gap-3 justify-center">
            <div className="w-48 h-48 rounded-3xl bg-gradient-to-tr from-[#0b3574] to-[#0b3574] p-1.5 shadow-xl relative overflow-hidden group cursor-pointer" onClick={() => setIsVideoModalOpen(true)}>
              <div className="w-full h-full bg-slate-900 dark:bg-[#070b15] rounded-2xl flex flex-col items-center justify-center text-white relative">
                <span className="text-4xl font-extrabold text-[#0b3574]">AIR 12</span>
                <span className="text-[10px] tracking-widest text-slate-400 font-bold uppercase mt-1">BARC Scientist</span>
                <div className="absolute bottom-2 text-[9px] bg-[#0b3574]/10 text-[#0b3574] px-2 py-0.5 rounded-full font-bold">Nilesh Nama</div>
                ...
                <div className="absolute inset-0 bg-black/30 flex items-center justify-center transition duration-300 group-hover:bg-black/50">
                  <div className="w-12 h-12 rounded-full bg-[#0b3574] flex items-center justify-center shadow-lg text-white group-hover:scale-110 transition duration-300">
            ...
            <button
              onClick={() => setIsVideoModalOpen(true)}
              className="text-xs font-bold text-[#0b3574] hover:text-[#38bdf8] hover:underline flex items-center gap-1.5 transition"
            >
              <span>Watch Sample Class Video</span>
            </button>
          </div>
          <div className="w-full md:w-2/3 space-y-4">
            <span className="inline-block text-[#0b3574] dark:text-[#38bdf8] text-xs font-bold uppercase tracking-wider text-left">Meet Your Coach</span>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-200 dark:border-slate-800 text-left">
              <div>
                <h4 className="text-lg sm:text-xl font-bold text-[#0b3574] dark:text-[#38bdf8]">AIR 12</h4>
                <p className="text-[9px] sm:text-[10px] text-slate-400 font-semibold">BARC Scientist Exam</p>
              </div>
              <div>
                <h4 className="text-lg sm:text-xl font-bold text-[#0b3574] dark:text-[#38bdf8]">AIR 202</h4>
                <p className="text-[9px] sm:text-[10px] text-slate-400 font-semibold">GATE CS Exam</p>
              </div>
              <div>
                <h4 className="text-lg sm:text-xl font-bold text-[#0b3574] dark:text-[#38bdf8]">99.9%</h4>
      ...
      <section id="curriculum" className="py-24 px-4 sm:px-6 max-w-5xl mx-auto scroll-mt-20">
        <div className="text-center mb-12">
          <span className="text-xs font-bold uppercase tracking-wider text-[#0b3574] dark:text-[#38bdf8]">Deep Subject Depth</span>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <button
                ...
                className={`w-full text-left px-5 py-4 rounded-2xl text-xs sm:text-sm font-bold transition-all duration-300 border flex flex-col gap-1 whitespace-nowrap md:whitespace-normal
                  ${activeSyllabusIdx === idx
                    ? "bg-[#0b3574]/10 border-[#0b3574] text-[#0b3574] dark:text-[#38bdf8] dark:bg-[#0b3574]/20"
          ...
          <div className="w-full md:w-2/3 bg-white dark:bg-[#0d1527] rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm">
            <h4 className="text-base sm:text-lg font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-2">
              <span className="w-1.5 h-6 bg-[#0b3574] rounded-full" />
            ...
            <ul className="space-y-4">
              {CURRICULUM_DATA[activeSyllabusIdx].topics.map((topic, i) => (
                <li key={i} className="flex items-start gap-3 text-xs sm:text-sm text-slate-600 dark:text-gray-300 text-left">
                  <span className="w-5 h-5 rounded-full bg-[#0b3574]/10 dark:bg-[#0b3574]/20 text-[#0b3574] dark:text-[#38bdf8] font-bold text-[10px] flex items-center justify-center shrink-0 mt-0.5">
                    {i + 1}
                  </span>
      ...
      <section className="bg-slate-50 dark:bg-slate-900/40 py-20 px-4 sm:px-6 border-t border-b border-slate-200 dark:border-slate-800 scroll-mt-20">
        <div className="max-w-3xl mx-auto text-center">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#0b3574]/20 bg-[#0b3574]/5 dark:bg-[#0b3574]/20 text-[#0b3574] dark:text-[#38bdf8] text-[10px] font-bold shadow-sm mb-4">
          ...
          <div className="mt-8 bg-white dark:bg-[#0d1527] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 text-left shadow-sm">
            ...
            {sandboxAnswer === "correct" && (
              <div className="mt-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-xs sm:text-sm text-emerald-800 dark:text-emerald-300 transition-all duration-300">
                ...
                <div className="mt-3">
                  <a href="#pricing" className="inline-flex items-center gap-1 bg-[#0b3574] text-white hover:bg-[#07214a] font-bold px-4 py-2 rounded-lg text-xs transition">
      ...
      <div className="w-full bg-[#0b3574] text-white overflow-hidden py-3 font-semibold text-xs tracking-wider select-none border-t border-b border-[#051836] relative flex items-center">
          ...
          <div className="inline-flex p-1 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 mt-8 shadow-inner">
            <button
              ...
              className={`px-6 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300
                ${activeYearTab === "gate2027" ? "bg-[#0b3574] text-white shadow-sm" : "text-slate-500 dark:text-gray-400"}`}
            >
              2027 Courses
            </button>
            <button
              ...
              className={`px-6 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300
                ${activeYearTab === "gate2028" ? "bg-[#0b3574] text-white shadow-sm" : "text-slate-500 dark:text-gray-400"}`}
            >
              2028 Courses
            </button>
          </div>
                ...
                className={`relative rounded-3xl border flex flex-col justify-between bg-white dark:bg-[#0d1527] p-6 shadow-sm hover:shadow-md transition duration-300
                  ${isRecommended 
                    ...
                    : p.badge === "Most Popular" 
                      ? "border-[#0b3574] dark:border-[#0b3574]/60 ring-2 ring-[#0b3574]/10" 
                      : "border-slate-200 dark:border-slate-800"}`}
              >
                {/* Early Bird Ribbon */}
                {p.originalPrice && (
                  <div className="absolute top-[-10px] right-[-10px] bg-[#0b3574] text-white text-[9px] font-bold px-2 py-2 rounded-full shadow shadow-[#0b3574]/20 flex flex-col items-center justify-center leading-none w-10 h-10 border border-white z-10">
                    <span>30%</span>
                ...
                <div className="flex items-baseline gap-1.5 mt-3">
                  <span className="text-2xl font-black text-[#0b3574] dark:text-[#38bdf8]">{p.price}</span>
                  {p.originalPrice && (
      ...
      <section className="py-20 px-4 sm:px-6 max-w-5xl mx-auto border-t border-slate-200 dark:border-slate-800">
        <div className="text-center mb-12">
          <span className="text-xs font-bold uppercase tracking-wider text-[#0b3574] dark:text-[#38bdf8]">Choose Smartly</span>
          <h2 className="text-3xl sm:text-4xl font-bold  text-slate-900 dark:text-white mt-1">
          ...
          <table className="w-full text-left text-xs sm:text-sm">
            <thead className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 text-slate-700 dark:text-gray-200">
              <tr>
                ...
                <th className="p-4 sm:p-5 font-bold text-center text-[#0b3574] dark:text-[#38bdf8]">PYQ Core</th>
      ...
      <section className="bg-[#0b1329] text-white py-24 px-4 sm:px-6 relative overflow-hidden">
        <div className="max-w-6xl mx-auto text-center scroll-mt-20" id="results">
          ...
          <div className="relative mt-12 flex items-center justify-center gap-4 sm:gap-6 overflow-hidden py-4 w-full select-none">
            ...
            {/* CENTER FOCUS CARD */}
            <div className="relative w-full max-w-xl min-h-[300px] rounded-3xl border border-[#0b3574]/80 bg-[#0d172e] p-6 sm:p-8 shadow-2xl shadow-[#0b3574]/5 transition-all duration-500 shrink-0 flex flex-col justify-between">
              ...
              <div>
                <div className="flex items-center gap-4 mb-5 text-left">
                  <div className="w-14 h-14 rounded-full border-2 border-[#0b3574] bg-[#0b3574]/10 flex items-center justify-center text-[#38bdf8] font-black text-lg overflow-hidden shrink-0">
            ...
            <button
              onClick={handlePrevStory}
              className="absolute left-2 md:left-8 w-10 h-10 rounded-full bg-slate-950/40 hover:bg-[#0b3574] text-white flex items-center justify-center transition border border-slate-800 backdrop-blur-sm shadow z-20 cursor-pointer select-none"
            >
              ←
            </button>
            <button
              onClick={handleNextStory}
              className="absolute right-2 md:right-8 w-10 h-10 rounded-full bg-slate-950/40 hover:bg-[#0b3574] text-white flex items-center justify-center transition border border-slate-800 backdrop-blur-sm shadow z-20 cursor-pointer select-none"
            >
              →
            </button>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 max-w-5xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl font-bold  text-slate-900 dark:text-white">
          Free <span className="text-[#0b3574] dark:text-[#38bdf8]">GATE CS</span> Resources
        </h2>
      ...
      <section className="py-12 px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="rounded-[2.5rem] bg-gradient-to-r from-[#061d33] via-[#0d2744] to-[#12365c] text-white p-8 sm:p-14 text-center relative overflow-hidden shadow-lg shadow-[#061d33]/15">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            <a
              href="#pricing"
              className="bg-[#0b3574] hover:bg-[#07214a] text-white font-bold px-8 py-3.5 rounded-2xl text-xs sm:text-sm transition-all duration-300 shadow-md w-full sm:w-auto text-center"
            >
              Enroll Now →
            </a>
            <a
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-slate-800 hover:bg-[#0b3574] text-white flex items-center justify-center transition"
                title="LinkedIn"
              >
                <LinkedInIcon />
              </a>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm transition-all duration-300">
          <div className="relative w-full max-w-4xl bg-[#0d1527] border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-[#0d1527]">
              <span className="text-xs sm:text-sm font-extrabold text-[#0b3574] tracking-wider uppercase">Sample Lecture Preview</span>
              <button
