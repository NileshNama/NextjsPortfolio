...
export default function CVPage() {
  ...
  return (
    <main className="w-full bg-white dark:bg-darkTheme text-black dark:text-white font-Ovo px-[12%] py-20">
      ...
      <section className="max-w-4xl mx-auto mb-12">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 dark:text-gray-300 mt-1">{current.title}</p>
            ...
            <div className="mt-6">
              <a
                ...
                target="_blank"
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-gray-400 dark:border-white/20 rounded-md text-sm hover:bg-gray-100 dark:hover:bg-white/10 transition"
              >
                Download CV (PDF)
                <span>↓</span>
              </a>
