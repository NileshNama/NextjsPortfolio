...
const Header = () => {
  return (
    <section
      id="home"
      className="w-full min-h-[100svh] flex items-start sm:items-center justify-center pt-10 sm:pt-12 pb-4 overflow-hidden"
    >
      <div className="w-11/12 max-w-4xl text-center mx-auto flex flex-col items-center gap-2 sm:gap-3 relative">
        ...
        >
          <div className="absolute w-24 h-24 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-full bg-[#5A9B92]/20 blur-3xl -z-10" />
          <Image
            src={assets.profile_img}
            alt="Nilesh Nama"
            className="rounded-full w-24 sm:w-40 md:w-48 relative z-10 shadow-[0_20px_60px_rgba(0,0,0,0.12)]"
          />
        </motion.div>
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
          className="text-[2.2rem] leading-none sm:text-5xl md:text-6xl font-semibold font-Ovo tracking-tight"
        >
          NILESH NAMA
        </motion.h1>
        ...
        >
          <div className="w-full max-w-[280px] sm:w-auto sm:min-w-[220px] px-4 py-2 rounded-2xl border border-gray-300/80 bg-white/80 backdrop-blur-sm text-[12px] sm:text-sm font-medium text-gray-700 shadow-sm transition-all duration-300 text-center">
            GATE • BARC • PSU Focused
          </div>

          <div className="w-full max-w-[280px] sm:w-auto sm:min-w-[240px] px-4 py-2 rounded-2xl border border-gray-300/80 bg-white/80 backdrop-blur-sm text-[12px] sm:text-sm font-medium text-gray-700 shadow-sm transition-all duration-300 text-center">
